...
public class Reverse {
     public static String Reversewinner;
      ...
      public static void main(int itemID) throws FileNotFoundException{
        ...
        else if(data[5].equals("closed")){
            System.out.println("Sorry,the auction for this item has been closed");
            System.out.println("The winner is "+Reversewinner);
            Bidder.main();
        }
        else if(data[5].equals("reject")){
            System.out.println("Sorry,the auction for this item has been closed due to auctioneer is not satisfied with the price");
            Bidder.main();
        }
    }
